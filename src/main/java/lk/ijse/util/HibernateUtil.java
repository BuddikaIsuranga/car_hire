...
public class HibernateUtil {
    ...
    private static SessionFactory buildSessionFactory() {
        ...
        Metadata metadata = new MetadataSources(standardRegistry).addAnnotatedClass(CustomerEntity.class).addAnnotatedClass(CarEntity.class).addAnnotatedClass(CatergoryEntity.class).addAnnotatedClass(RentEntity.class).getMetadataBuilder().applyImplicitNamingStrategy(ImplicitNamingStrategyJpaCompliantImpl.INSTANCE).build();
